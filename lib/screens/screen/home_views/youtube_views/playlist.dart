              ...
              slivers: [
                                ...
                                child: Stack(
                                  children: [
                                    SizedBox(
                                      height: 180,
                                      width: 180,
                                      child: loadImageCached(widget.imgPath),
                                    ),
                                  ],
                                ),
                              ),
                ...
                SliverList.list(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 16, top: 20, bottom: 5),
                      child: Text("Songs",
                      ...
                      return YtSongTile(
                        ...
                        onOpts: () {
                          SnackbarService.showMessage(
                              ...
                              loading: true);
                          fetchSong(items[index]["id"]!, items[index]["image"]!)
                              .then((value) {
                            SnackbarService.showMessage(
                            ...
                            log("Error: $error", name: "YoutubePlaylist");
                            SnackbarService.showMessage(
                                "Error getting song information.");
                          });
                        },
                        onTap: () async {
                          SnackbarService.showMessage("Loading song...",
                              loading: true);
                          await getMediaOps.cancel();

                          if (songList[index] == null) {
                            getMediaOps = CancelableOperation.fromFuture(
                              fetchSong(
                                  items[index]["id"]!, items[index]["image"]!),
                              onCancel: () {
                                log("skipping....", name: "YoutubePlaylist");
                                return;
                              },
                            );
                            ...
                            context
                                .read<BloomeePlayerCubit>()
                                .bloomeePlayer
                                .addQueueItem(songList[index]!, doPlay: true);
                          }
                        },
                      );
                    },
