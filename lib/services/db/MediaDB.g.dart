...
void _mediaItemDBSerialize(
  ...
  writer.writeBool(offsets[5], object.isLiked);
  writer.writeString(offsets[6], object.language);
  writer.writeString(offsets[7], object.mediaID);
  writer.writeString(offsets[8], object.permaURL);
  writer.writeString(offsets[9], object.source);
  writer.writeString(offsets[10], object.streamingURL);
...
MediaItemDB _mediaItemDBDeserialize(
  ...
  final object = MediaItemDB(
    ...
    genre: reader.readString(offsets[3]),
    id: id,
    isLiked: reader.readBool(offsets[5]),
    language: reader.readString(offsets[6]),
    mediaID: reader.readString(offsets[7]),
    permaURL: reader.readString(offsets[8]),
    source: reader.readStringOrNull(offsets[9]),
    streamingURL: reader.readString(offsets[10]),
